...
Citizen.CreateThread(function()
	exports['rsg-core']:createPrompt('saint_denis_cin', vector3(2541.56, -1282.03, 49.27), 0x760A9C6F, 'Theatre Menu', {
            type = 'client',
	...
	exports['rsg-core']:createPrompt('blackwater_cin', vector3(-788.55, -1362.62, 44.58), 0x760A9C6F, 'Cinema Menu', {
            type = 'client',
            event = 'rsg-cinema:client:menu',
            args = {},
        })
...
RegisterNetEvent("rsg-cinema:startShow")
AddEventHandler("rsg-cinema:startShow", function(show)
...
RegisterNetEvent("rsg-cinema:startShow1")
AddEventHandler("rsg-cinema:startShow1", function(showname)
	StartShow(showname)	
end)

RegisterNetEvent("rsg-cinema:startShow2")
AddEventHandler("rsg-cinema:startShow2", function(showname)
...
RegisterNetEvent('rsg-cinema:client:menu')
AddEventHandler('rsg-cinema:client:menu', function()
	exports['rsg-menu']:openMenu({
        ...
        },
        {
            ...
            txt = "Show Menu",
            params = {
                event = 'rsg-cinema:client:menuShows',
				isServer = false,
            }
        },
		{
            ...
            txt = "Moving Pictures",
            params = {
                event = 'rsg-cinema:client:menuMovies',
				isServer = false,
            }
        },
        {
...
RegisterNetEvent('rsg-cinema:client:menuShows')
AddEventHandler('rsg-cinema:client:menuShows', function()
	local city = GetCurrentTownName()
	if city == "SAINTDENIS" then 
		exports['rsg-menu']:openMenu({
			...
			},
			{
				...
				txt = "More Shows",
				params = {
					event = 'rsg-cinema:client:menuShows2',
					isServer = false,
		...
		lib.notify({ title = '📽️', description = 'Only Available in Saint Denis!', type = 'error', duration = 5000 })
	end
end)

RegisterNetEvent('rsg-cinema:client:menuShows2')
AddEventHandler('rsg-cinema:client:menuShows2', function()
...
RegisterNetEvent('rsg-cinema:client:menuMovies')
AddEventHandler('rsg-cinema:client:menuMovies', function()
	...
	exports['rsg-menu']:openMenu({
        ...
        },
		{
            ...
            txt = "More Movies",
            params = {
                event = 'rsg-cinema:client:menuMovies2',
				isServer = false,
...
RegisterNetEvent('rsg-cinema:client:menuMovies2')
AddEventHandler('rsg-cinema:client:menuMovies2', function()
